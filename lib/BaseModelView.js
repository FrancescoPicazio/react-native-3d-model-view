    ...
    if (source.zip) {
      ...
      if (source.model) {
        ...
        if (
          ...
          source.model.startsWith("file://")
        ) {
          var modelSrc = source.model;
          modelSrc = modelSrc.replace("file://", "");
          this.setState({ modelSrc });
        } else {
          if (
            typeof source.model === "string" &&
      ...
      if (source.texture) {
        ...
        if (
          ...
          source.texture.startsWith("file://")
        ) {
          var textureSrc = source.texture;
          textureSrc = textureSrc.replace("file://", "");
